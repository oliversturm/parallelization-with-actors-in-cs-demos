...
#docker run --rm -it --volume .:/src -w /src oliversturm/dotnet-demo:1 bash -c "tmux new-session -d -s demo 'bash'; tmux split-window -h -t demo 'bash'; tmux attach-session -t demo"
